...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string my_conn = ConfigurationManager.connectionString["shaadi_bandhanConnectionString"];
        conn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=D:\PROJECT\FINAL ONLINE MATRIMONIAL\shaadi_bandhan.mdf;Integrated Security=True;User Instance=True");
        conn.Open();
