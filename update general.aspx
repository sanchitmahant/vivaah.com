<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="update general.aspx.cs" Inherits="update_general" Title="Untitled Page" %>
    ...
    <table style="width:100%;">
        <tr>
            <td align="justify" colspan="2">
                <asp:Label ID="Label32" runat="server" Font-Bold="True" Font-Italic="True" 
                    ...
                    Text="UPDATE GENERAL INFORMATION" BackColor="#FF0066" Width="290px"></asp:Label>
                <br />
                <br />
            </td>
        </tr>
        ...
        <tr>
            <td class="style48">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Maritial Status" style="margin-right: 0px" Width="129px" 
                    ForeColor="#660066"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td class="style49">
                <asp:RadioButtonList ID="txtmarri" runat="server" Font-Size="X-Small" 
                    RepeatDirection="Horizontal" Width="281px" Height="16px" RepeatColumns="3" 
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Height" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ...
                    ForeColor="#D20000" SetFocusOnError="True" ControlToValidate="txtheight" 
        ...
        <tr>
            <td class="style56">
                <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Weight" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style57">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ...
                    ForeColor="#D20000" SetFocusOnError="True" ControlToValidate="txtweight" 
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Diet" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
                <asp:RadioButtonList ID="txtdiet" runat="server" Font-Bold="True" 
                    Font-Size="X-Small" RepeatDirection="Horizontal" Width="314px" Height="16px" 
                    AutoPostBack="True" onselectedindexchanged="txtdiet_SelectedIndexChanged" 
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Smoke" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
                <asp:RadioButtonList ID="txtsmoke" runat="server" Font-Bold="True" 
                    Font-Size="X-Small" Height="16px" RepeatDirection="Horizontal" Width="359px" 
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label26" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Personal Value" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
                <asp:RadioButtonList ID="txtperval" runat="server" Font-Bold="True" 
                    Font-Size="X-Small" Height="16px" RepeatDirection="Horizontal" 
                    Width="244px" AutoPostBack="True" ForeColor="Black">
        ...
        <tr>
            <td class="style52">
                <asp:Label ID="Label27" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Complextion" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style53">
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label28" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Body Type" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
        ...
        <tr>
            <td class="style50">
                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Phsical Status" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style51">
        ...
        <tr>
            <td class="style54">
                <asp:Label ID="Label29" runat="server" Font-Bold="True" Font-Size="X-Small" 
                    Text="Describe Yourself" ForeColor="#660066"></asp:Label>
            </td>
            <td class="style55">
        ...
        <tr>
            <td>
                ...
                ForeColor="#C10000"></asp:Label>
            </td>
            <td>
                <asp:Button ID="Button1" runat="server" Font-Size="X-Small" ForeColor="#50009F" 
                    Text="UPDATE" Width="60px" onclick="Button1_Click" 
                    ValidationGroup="valid" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" Text="CANCEL" Font-Size="X-Small" 
                    ForeColor="#50009F" Height="20px" onclick="Button2_Click" Width="60px" />
            </td>
        </tr>
        <tr>
            <td>
