...
public partial class about_yourself : System.Web.UI.Page
{
    SqlConnection conn;
    SqlCommand cmd;
    SqlDataReader rdr;
    ...
    {
        cmd = new SqlCommand("insert into about_yourself(education_field,education_level,work_status,work_area,income,income_type1,income_type2,income_amount,email_id)values(@education_field,@education_level,@work_status,@work_area,@income,@income_type1,@income_type2,@income_amount,@email_id)", conn);
        ...
        cleartxt();
        Response.Redirect("family_details.aspx");
